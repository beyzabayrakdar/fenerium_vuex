    ...
    <div class="modal-content">
      ...
      <div class="tab-content">
        ...
        <div id="signUp" class="tab-pane fade active show">
          ...
          <div class="modal-body">
            ...
            >
              <input
                name="__RequestVerificationToken"
                type="hidden"
                value="uwpdeshSYFJ3xY-XUVb6zLWgoHtZq-L5ZuTjhyZ63jCMIr9GBs-fl9k2fDtNUP9Nujt6irxo2oYXIPEjXA-3d8a_cg5kE69q7M1sfiQAbVg1"
              />
              <div class="form-header">
                <div class="form-group rendered">
                  <input
          ...
          <div class="modal-footer">
            <nav class="nav">
              <a href="/header/giris" data-toggle="tab" class="modal-link"
